 ...
 *
 * @property int $attempt_id Попытка
 * @property int $question_id Вопрос
 * @property-read string $updated Обновление
 * @property-read string $result Результат
 * @property double $mark Оценка
 *
 * @property-read TestAttempt $attempt
 * @property-read TestQuestion $question
 */
