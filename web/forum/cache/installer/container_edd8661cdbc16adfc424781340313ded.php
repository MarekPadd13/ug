...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000001b333000000000056da3f78(
...
class phpbbtemplatetwiglexer_0000000001b333000000000056da3f78 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b4b6b27e5b3b990080439 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b4b6b27e5b43871303274 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b4b6b27e5b25399820069 = array(
    ...
    {
        $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, 'set_environment', array('env' => $env), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;

        return $this->valueHolder5b4b6b27e5b3b990080439->set_environment($env);
    }
    ...
    {
        $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;

        return $this->valueHolder5b4b6b27e5b3b990080439->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;

        return $this->valueHolder5b4b6b27e5b3b990080439->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b4b6b27e5b43871303274 = $initializer;
    }
    ...
    {
        $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, '__get', array('name' => $name), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;

        if (isset(self::$publicProperties5b4b6b27e5b25399820069[$name])) {
            return $this->valueHolder5b4b6b27e5b3b990080439->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b4b6b27e5b3b990080439;
    ...
    {
        $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;
    ...
    {
        $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, '__isset', array('name' => $name), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;
    ...
    {
        $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, '__unset', array('name' => $name), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;
    ...
    {
        $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, '__clone', array(), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;

        $this->valueHolder5b4b6b27e5b3b990080439 = clone $this->valueHolder5b4b6b27e5b3b990080439;
    }

    public function __sleep()
    {
        $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, '__sleep', array(), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;

        return array('valueHolder5b4b6b27e5b3b990080439');
    }
    ...
    {
        return $this->initializer5b4b6b27e5b43871303274;
    }
    ...
    {
        return $this->initializer5b4b6b27e5b43871303274 && ($this->initializer5b4b6b27e5b43871303274->__invoke($valueHolder5b4b6b27e5b3b990080439, $this, 'initializeProxy', array(), $this->initializer5b4b6b27e5b43871303274) || 1) && $this->valueHolder5b4b6b27e5b3b990080439 = $valueHolder5b4b6b27e5b3b990080439;
    }
    ...
    {
        return null !== $this->valueHolder5b4b6b27e5b3b990080439;
    }
    ...
    {
        return $this->valueHolder5b4b6b27e5b3b990080439;
    }
