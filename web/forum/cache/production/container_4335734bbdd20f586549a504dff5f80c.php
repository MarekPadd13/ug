...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000c560e4b000000007579606f(
...
class phpbbtemplatetwiglexer_000000000c560e4b000000007579606f extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b4b6b3c44b45706862684 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b4b6b3c44b4d866557063 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b4b6b3c44b2f666505456 = array(
    ...
    {
        $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, 'set_environment', array('env' => $env), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;

        return $this->valueHolder5b4b6b3c44b45706862684->set_environment($env);
    }
    ...
    {
        $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;

        return $this->valueHolder5b4b6b3c44b45706862684->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;

        return $this->valueHolder5b4b6b3c44b45706862684->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b4b6b3c44b4d866557063 = $initializer;
    }
    ...
    {
        $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, '__get', array('name' => $name), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;

        if (isset(self::$publicProperties5b4b6b3c44b2f666505456[$name])) {
            return $this->valueHolder5b4b6b3c44b45706862684->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b4b6b3c44b45706862684;
    ...
    {
        $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;
    ...
    {
        $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, '__isset', array('name' => $name), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;
    ...
    {
        $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, '__unset', array('name' => $name), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;
    ...
    {
        $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, '__clone', array(), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;

        $this->valueHolder5b4b6b3c44b45706862684 = clone $this->valueHolder5b4b6b3c44b45706862684;
    }

    public function __sleep()
    {
        $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, '__sleep', array(), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;

        return array('valueHolder5b4b6b3c44b45706862684');
    }
    ...
    {
        return $this->initializer5b4b6b3c44b4d866557063;
    }
    ...
    {
        return $this->initializer5b4b6b3c44b4d866557063 && ($this->initializer5b4b6b3c44b4d866557063->__invoke($valueHolder5b4b6b3c44b45706862684, $this, 'initializeProxy', array(), $this->initializer5b4b6b3c44b4d866557063) || 1) && $this->valueHolder5b4b6b3c44b45706862684 = $valueHolder5b4b6b3c44b45706862684;
    }
    ...
    {
        return null !== $this->valueHolder5b4b6b3c44b45706862684;
    }
    ...
    {
        return $this->valueHolder5b4b6b3c44b45706862684;
    }
